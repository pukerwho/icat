    ...
    <div id="citylist-faq" class="mb-6">
      ...
      <div>
        <div itemscope itemtype="https://schema.org/FAQPage">
          ...
          ?>
            <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" class="border-b border-gray-200 pb-4 mb-4 last-of-type:border-none last-of-type:pb-0 last-of-type:mb-0">
              <div class="font-bold mb-2" itemprop="name"><?php echo $post_faq['crb_block_faq_question']; ?></div>
              <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" class="font-light">
                <div itemprop="text"><?php echo $post_faq['crb_block_faq_answer']; ?></div>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
