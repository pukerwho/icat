...
function tutCount($id) {
    if ( metadata_exists( 'post', $id, 'item_count' ) ) {
      $count_value = get_post_meta( $id, 'item_count', true );
      $count_value = $count_value + 1;
      update_post_meta( $id, 'item_count', $count_value );
    } else {
      $rand_item_count = mt_rand(50, 144);
      add_post_meta( $id, 'item_count', $rand_item_count, true);
    }
    $item_count = get_post_meta( $id, 'item_count', true );
    return $item_count;
}
